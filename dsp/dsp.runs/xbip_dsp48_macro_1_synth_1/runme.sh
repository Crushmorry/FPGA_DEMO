...
HD_PWD='E:/fpga_proj/dsp/dsp.runs/xbip_dsp48_macro_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xbip_dsp48_macro_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xbip_dsp48_macro_1.tcl
