...
HD_PWD='E:/FPGA_DEMO/dsp/dsp.runs/xbip_dsp48_macro_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xbip_dsp48_macro_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xbip_dsp48_macro_2.tcl
