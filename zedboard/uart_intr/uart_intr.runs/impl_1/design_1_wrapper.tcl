...
namespace eval ::optrace {
  variable script "E:/fpga_proj/ps/uart_intr/uart_intr.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/fpga_proj/ps/uart_intr/uart_intr.runs/synth_1/design_1_wrapper.dcp
