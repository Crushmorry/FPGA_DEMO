...
namespace eval ::optrace {
  variable script "E:/fpga_proj/ps/axi_dma/axi_dma.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/fpga_proj/ps/axi_dma/axi_dma.runs/synth_1/design_1_wrapper.dcp
