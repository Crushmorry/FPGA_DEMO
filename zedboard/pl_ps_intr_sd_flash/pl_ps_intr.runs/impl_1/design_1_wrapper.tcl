...
namespace eval ::optrace {
  variable script "E:/fpga_proj/ps/pl_ps_intr/pl_ps_intr.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/fpga_proj/ps/pl_ps_intr/pl_ps_intr.runs/synth_1/design_1_wrapper.dcp
