...
HD_PWD='E:/FPGA_DEMO/zedboard/hdmi_vdma/hdmi_vdma.runs/design_1_rst_clk_wiz_0_74M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_74M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_74M_0.tcl
