...
#
# Generated by Vivado on Thu Nov 12 20:47:23 +0800 2020
...
# Script info
echo -e "axi_iic_0.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L lib_pkg_v1_0_2 -L lib_cdc_v1_0_2 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_iic_v2_0_24 -L xil_defaultlib -L secureip -L xpm --snapshot axi_iic_0 xil_defaultlib.axi_iic_0 -log elaborate.log
}
